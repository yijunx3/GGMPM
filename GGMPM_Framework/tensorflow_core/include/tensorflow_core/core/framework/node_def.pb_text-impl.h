...
#ifndef tensorflow_core_framework_node_def_proto_IMPL_H_
#define tensorflow_core_framework_node_def_proto_IMPL_H_
...
#endif  // tensorflow_core_framework_node_def_proto_IMPL_H_
