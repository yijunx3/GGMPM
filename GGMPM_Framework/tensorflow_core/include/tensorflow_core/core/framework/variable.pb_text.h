...
// Enum text output for tensorflow.VariableSynchronization
const char* EnumName_VariableSynchronization(
    ::tensorflow::VariableSynchronization value);

// Enum text output for tensorflow.VariableAggregation
const char* EnumName_VariableAggregation(
    ::tensorflow::VariableAggregation value);
